class StudentChat {
  constructor() {
    ...
    this.appState = {
      ...
      selectedFiles: [],
      workflowApiUrl: 'https://workflow-3ont3iztd-toropilja374-gmailcoms-projects.vercel.app',
      messageIndex: 0
    };
          ...
          if (workflowState.ub_id === this.appState.ubId && 
            ...
            workflowState.answers.forEach((answer, index) => {
              if (answer.user_message) {
                this.createUserMessage(answer.user_message, null, answer.user_files || []);
              }
              ...
              if (answer.answer) {
                this.createUserMessage(answer.answer, null, answer.user_files || []);
              }
            });
