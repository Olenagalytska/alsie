class StudentChat {
  constructor() {
    ...
    this.appState = {
      ...
      selectedFile: null,
      workflowApiUrl: 'https://workflow-oa2sgcu3b-toropilja374-gmailcoms-projects.vercel.app'
    };
  }
        ...
        if (workflowResponse.ok) {
          ...
          if (workflowState.answers && workflowState.answers.length > 0) {
            ...
            workflowState.answers.forEach(answer => {
              ...
              const otherAiResponse = answer.assistant_response || answer.coach_response || answer.tutor_response || answer.assignment || answer.agent_response;
              if (otherAiResponse) {
                this.createAssistantMessage(otherAiResponse);
              }
            });
