class StudentChat {
  constructor() {
    ...
    this.appState = {
      ...
      selectedFile: null,
      workflowApiUrl: 'https://workflow-p6a93upyc-toropilja374-gmailcoms-projects.vercel.app'
    };
  }
      ...
      chatWidget.setOptions({
        ...
        api: {
          ...
          uploadStrategy: async (file) => {
            ...
            const response = await fetch(`${workflowApiUrl}/chatkit/upload?ub_id=${ubId}&block_id=${blockId}`, {
              method: 'POST',
              body: formData
            });
