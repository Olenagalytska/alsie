class StudentChat {
  constructor() {
    ...
    this.appState = {
      ...
      selectedFile: null,
      workflowApiUrl: 'https://workflow-bitktiql3-toropilja374-gmailcoms-projects.vercel.app'
    };
  }
  ...
  if (chatWidget) {
    ...
    if (isSelfHosted) {
      ...
      chatWidget.setOptions({
        ...
        startScreen: {
          greeting: chatKitGreeting,  // Використовуємо змінну тут
          prompts: chatKitPrompts      // І тут також
        }
      });
